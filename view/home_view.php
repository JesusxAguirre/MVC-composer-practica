        ...
        <div class="container-fluid">
            ...
            <div class="dropdown ms-1 ms-lg-0">
				<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
					<img class="avatar-img rounded-circle" src="assets/img/avatar.jpg" width="40px" alt="avatar">
				</a>
					...
					<li class="px-3 mb-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="assets/img/avatar.jpg" width="40px" alt="avatar">
							</div>
							<div>
          ...
          <li> <hr class="dropdown-divider"></li>
					<!-- Links -->
					<li><a class="dropdown-item" href="?url=edit-perfil"><i class="bi bi-person fa-fw me-2"></i>Editar perfil</a></li>
